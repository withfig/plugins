  ...
  configuration: [
    {
      ...
      environmentVariable: "AUTOENV_FILE_ENTER",
    ...
    { 
      ...
      environmentVariable: "AUTOENV_FILE_LEAVE",
      type: "environmentVariable",
      description: "Name of the file to look for when leaving directories. Requires AUTOENV_HANDLE_LEAVE=1.",
    ...
    { 
      ...
      environmentVariable: "AUTOENV_LOOK_UPWARDS",
      type: "environmentVariable",
    ...
    { 
      ...
      environmentVariable: "AUTOENV_HANDLE_LEAVE",
      type: "environmentVariable",
      description: "Handle leave events when changing away from a subtree, where an \"enter\" event was handled?",
      default: true,
    ...
    { 
      ...
      environmentVariable: "AUTOENV_DISABLED",
      type: "environmentVariable",
      description: "(Temporarily) disable zsh-autoenv. This gets looked at in the chpwd handler.", 
      default: false,
      interface: "toggle",
      compile: (value) => {
        return value ? "1" : "0"
