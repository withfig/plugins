const plugin: Fig.Plugin = {
  ...
  configuration: [{
    ...
    environmentVariable: "POWERLINE_HIDE_USER_NAME",
    interface: "toggle",
    default: false,
    ...
    environmentVariable: "POWERLINE_HIDE_HOST_NAME",
    interface: "toggle",
    default: false,
    compile: value => value ? "true" : "",
  }, {
    ...
    type: "environmentVariable",
    description: "Hide git status (new files, modified files, unmerged files, etc.) from prompt",
    environmentVariable: "POWERLINE_HIDE_GIT_PROMPT_STATUS",
    interface: "toggle",
    default: false,
    compile: value => value ? "true" : "",
  }, {
    ...
    environmentVariable: "POWERLINE_NO_BLANK_LINE",
    interface: "toggle",
    default: true,
    compile: value => value ? "" : "true",
  }, {
    ...
    environmentVariable: "POWERLINE_DISABLE_RPROMPT",
    interface: "toggle",
    default: false,
    compile: value => value ? "true" : "",
  },
  ...
  */
  {
    ...
    configuration: [{
      ...
      type: "environmentVariable",
      description: "First element of the right prompt. Defaults to date if empty. Set to 'none' to disable. Can select an option or specify custom text.",
      environmentVariable: "POWERLINE_RIGHT_A",
      interface: "select",
      allowUserCreatedOptions: true,
      default: "",
      options: [
        { option: "", description: "Date (default)" },
        { option: "none", description: "Empty. Don't show first right prompt component." },
        { option: "exit-status", description: "Exit code of last command" },
        { option: "exit-status-on-fail", description: "Exit code of last command if failed" },
        { option: "mixed", description: "Display date or nonzero exit code of last command" },
      ],
    }, {
      displayName: "Date Format",
      type: "environmentVariable",
      hidden: ({ config }) => config["POWERLINE_RIGHT_A"] == "",
      description: "Date format used in first right prompt component when set to default",
      environmentVariable: "POWERLINE_RIGHT_A_COLOR_BACK",
      interface: "text",
      default: "%D{%Y-%m-%d}",
    }, {
      ...
      environmentVariable: "POWERLINE_RIGHT_A_COLOR_FRONT",
      interface: "text",
      default: "black",
    }, {
      ...
      type: "environmentVariable",
      description: "Second element of the right prompt. Defaults to time if empty. Set to 'none' to disable.",
      environmentVariable: "POWERLINE_RIGHT_B",
      interface: "select",
      allowUserCreatedOptions: true,
      default: "",
      options: ["", "none"],
