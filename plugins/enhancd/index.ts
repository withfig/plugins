const plugin: Fig.Plugin = {
  ...
  configuration: [
    ...
    { 
      ...
      description: "Specify the path of 3rd party filtering executable, like `fzf` or `peco`",
      additionalDetails: "The ENHANCD_FILTER is an environment variable. It looks exactly like the PATH variable containing with many different filters concatenated using '`:`'.",
      type: "environmentVariable",
    ...
    { 
      ...
      additionalDetails: '(e.g. Setting this value to `ls` will trigger behavior similiar to `cd && ls`)',
      type: "environmentVariable",
    ...
    },
    {
      ...
      configuration: [
        { 
          ...
          description: "If you don't want to use the interactive filter, when specifing a double dot (`..`)",
          type: "environmentVariable",
    ...
    },
    {
      ...
      configuration: [
        { 
          ...
          description: "If you don't want to use the interactive filter, when specifing a hyphen as the argument to `cd`",
          type: "environmentVariable",
        ...
        { 
          ...
          additionalDetails: "This value is passed to `head` comand as `-n` option.",
          type: "environmentVariable",
    ...
    },
    {
      ...
      configuration: [
        { 
          ...
          description: "If you don't want to use the interactive filter when you call `cd` without an argument",
          type: "environmentVariable",
        ...
        { 
          ...
          description: "You can customize to trigger the argumentless \`cd\` behavior by giving the string specified by this environment variable as an argument.",
          additionalDetails: 
          `
    ...
    },
    {
      ...
      configuration: [
        ...
        { 
          ...
          type: "environmentVariable",
          additionalDetails: "See [#90](https://github.com/b4b4r07/enhancd/issues/90).",
