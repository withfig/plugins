...
const prompt: ModuleConfiguration = {
  ...
  items: [{
      ...
      additionalDetails: "Setting it to 'random' loads a random theme. Auto set to 'off' on dumb terminals",
      type: "script",
      ...
      additionalDetails: "By default, it is set to 'short'. Set it to 'long' (without '~' expansion) for longer or 'full' (with '~' expansion) for even longer prompt display.",
      type: "script",
      interface: "select",
      ...
      name: "return-code",
      description: "Set the prompt to display the return code along with an indicator for non-zero return codes. This is not supported by all prompts.",
      type: "script",
      interface: "toggle",
      default: true,
