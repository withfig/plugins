...
const historySubstringSearch: ModuleConfiguration = {
  ...
  items: [{
    ...
    interface: "text",
    default: "",
    compile: compileZstyle(":prezto:module:history-substring-search:color", "found"),
  }, {
    ...
    interface: "text",
    default: "",
    compile: compileZstyle(":prezto:module:history-substring-search:color", "not-found"),
  }, {
    ...
    interface: "text",
    default: "",
    compile: compileZstyle(":prezto:module:history-substring-search", "globbing-flags"),
  }]
}
