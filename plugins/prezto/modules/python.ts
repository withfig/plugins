...
const python: ModuleConfiguration = {
  ...
  items: [{
    ...
    description: "Automatically switch the Python virtualenv on directory change.",
    type: "script",
    interface: "toggle",
    default: true,
    compile: compileZstyleBool(":prezto:module:python:virtualenv", "auto-switch"),
  }, {
    ...
    interface: "toggle",
    default: true,
    compile: compileZstyleBool(":prezto:module:python:virtualenv", "initialize"),
  }]
}
