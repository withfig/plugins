...
const plugin: Fig.Plugin = {
  ...
  configuration: [{
    ...
    configuration: [{
        ...
        name: "color",
        description: "Whether or not to color output (auto set to 'no' on dumb terminals).",
        type: "script",
        interface: "toggle",
        default: true,
        ...
        description: "Allow module overrides when pmodule-dirs causes module name collisions",
        type: "script",
        interface: "toggle",
        default: true,
