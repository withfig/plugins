  ...
  configuration: [
    ...
    },
    {
      ...
      additionalDetails:
        ...
        "alias); %command - the command that was typed by the user; %alias - " +
        "the matching alias that was found",
      type: "environmentVariable",
      name: "YSU_MESSAGE_FORMAT",
      interface: "text",
    },
    {
    ...
    },
    {
      ...
      type: "environmentVariable",
      name: "YSU_IGNORED_GLOBAL_ALIASES",
      interface: "multi-text",
      default: [],
    },
  ],
